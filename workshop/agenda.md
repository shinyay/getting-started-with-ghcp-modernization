...
## Full-Day Workshop (6 hours 30 minutes core + 50 minutes optional Lab 7)
...
| Discussion | Interactive group discussion |

## Which Format Should You Choose?

- **Half-day**: Best for teams that want an introduction with hands-on experience. Covers the core workflow (IDE upgrade + CLI assessment + custom skills).
- **Full-day**: Best for teams planning real modernization. Adds predefined tasks, CLI execution, and bring-your-own-app practice.
